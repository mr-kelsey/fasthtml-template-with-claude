...
from farm.db import FarmDatabaseMixin  # noqa: E402 -- after _CoreDatabase, farm.db is a pure mixin (no circular import)


class Database(FarmDatabaseMixin, _CoreDatabase):
    "Composes the core (notes/calendar) and farm-planning schema/queries onto one engine/instance."

    SCHEMA_STATEMENTS = _CoreDatabase.SCHEMA_STATEMENTS + FarmDatabaseMixin.SCHEMA_STATEMENTS
